...
,
  ...
  },
  {
    ...
    "options": ["The AI learns by trial and error.", "The AI learns from data that is already labeled with the correct answers.", "The AI organizes data into clusters without help.", "The AI is supervised by a human in real-time."],
    "correct": 1,
  ...
  },
  {
    ...
    "correct": 1,
    "explanation": "A label is the 'ground truth' or answer associated with a data point in supervised learning."
  },
  {
...
,
  ...
  {
    "question": "Scenario: You need an algorithm for a real-time system that must give an answer within 5 seconds. If it can't find the best, it should return the best it found so far. This is an:",
  ...
  },
  {
    ...
    "options": ["To combine parents.", "To introduce random changes to individuals to maintain population diversity.", "To select the best individuals.", "To calculate the final answer."],
    "correct": 1,
...
,
  ...
  },
  {
    ...
    "correct": 1,
    "explanation": "Decidability refers to the existence of a guaranteed computational path to an answer."
  },
  {
...
,
  ...
  },
  {
    ...
    options: ["To save memory", "To prevent the search from getting stuck in a local optimum cycle", "To store the final answer", "To provide a heuristic for A*"],
    answer: 1,
  ...
  {
    question: "A customer support chatbot uses 'Semantic Search' to find answers in a PDF manual. Instead of searching for exact keywords, it converts the user's question into a 'Vector Embedding'. This technical process relies on:",
